...
class ToDosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create to_do" do
    assert_difference('ToDo.count') do
      post to_dos_url, params: { to_do: { due_date: @to_do.due_date, priority: @to_do.priority, task: @to_do.task } }
    end
  ...
  test "should update to_do" do
    patch to_do_url(@to_do), params: { to_do: { due_date: @to_do.due_date, priority: @to_do.priority, task: @to_do.task } }
